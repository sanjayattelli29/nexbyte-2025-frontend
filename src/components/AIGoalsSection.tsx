...
const AIGoalsSection = ({
    title = "AI Goals",
    subtitle = "Explore our latest advancements, research, and milestones in Artificial Intelligence.",
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-12">
                        ...
                        <Link to="/ai-posts" className="hidden md:inline-flex">
                    ...
                    {posts.length === 0 ? (
                        <div className="text-center py-12 bg-gray-50 rounded-lg border border-dashed border-gray-200">
                            <p className="text-muted-foreground mb-4">No AI updates available at the moment.</p>
                            <Link to="/ai-posts" className="md:hidden">
                                <Button variant="outline" className="gap-2">
                                    {buttonText} <ArrowRight className="w-4 h-4" />
                                </Button>
                            </Link>
                                ...
                                <Card key={post._id} className="overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col h-full bg-white">
                                    ...
                                    <CardContent className="p-3 pt-0 flex-1 flex flex-col">
                                        ...
                                        <div className="flex justify-between items-center mt-2 pt-1">
                                            ...
                                            <Link to={`/ai-posts/${post._id}`} className="flex-1">
