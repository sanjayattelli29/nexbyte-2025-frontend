...
const CSECorePostManager = ({ showControls = true }: { showControls?: boolean }) => {
    ...
    const fetchPosts = async () => {
        ...
        try {
            ...
            let url = `${API_BASE_URL}/api/admin/cse-core-posts?sort=${sortBy}`;
    ...
    const fetchCategories = async () => {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/cse-core-categories?includeHidden=true`);
            const data = await response.json();
            if (data.success) {
    ...
    const handleCreateCategory = async () => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/api/cse-core-categories`, {
                method: "POST",
    ...
    const handleDeleteCategory = async (id: string) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/api/cse-core-categories/${id}`, {
                method: "DELETE"
            });
            if (response.ok) {
    ...
    const toggleCategoryVisibility = async (id: string, currentStatus: boolean) => {
        try {
            const response = await fetch(`${API_BASE_URL}/api/cse-core-categories/${id}/visibility`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
    ...
    const handleCreatePost = async () => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/api/cse-core-posts`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    const handleUpdatePost = async () => {
        ...
        setUploading(true);
        try {
            const response = await fetch(`${API_BASE_URL}/api/cse-core-posts/${editingPostId}`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    type: 'edit',
    ...
    const handleDeletePost = async (id: string) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/api/cse-core-posts/${id}`, {
                method: "DELETE"
            });
            if (response.ok) {
    ...
    const toggleVisibility = async (id: string, currentStatus: boolean) => {
        try {
            await fetch(`${API_BASE_URL}/api/cse-core-posts/${id}`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <Card className="lg:col-span-1 h-fit">
                        <CardHeader>
                            <CardTitle>{editingPostId ? "Edit Post" : "Create New CSE Core Post"}</CardTitle>
                    ...
                    <div className="lg:col-span-2">
                        <div className="flex flex-col sm:flex-row justify-between items-center mb-4 gap-4">
                            <h2 className="text-xl font-bold">Recent CSE Core Posts ({filteredPosts.length})</h2>
...
export default CSECorePostManager;
