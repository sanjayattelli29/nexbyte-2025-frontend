                            ...
                            <div className="bg-gray-50/50 border-t border-gray-100 px-6 py-4 flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    ...
                                    {post.actionLink && (
                                        <Button
                                            variant="outline"
                                            className="h-8 text-xs border-violet-200 text-violet-600 hover:bg-violet-50 hover:text-violet-700 flex items-center justify-center gap-1.5 transition-colors"
